...
def parse():
    ...
    parser.add_argument('--chans', type=int, default=13, help='Number of channels for cascade U-Net')
...
if __name__ == '__main__':
    ...
    if args.mode == "leaderboard":
        ...
        args.forward_dir = "../result" / args.net_name / "reconstructions_val_model6"
    
    else : 
        args.forward_dir = "../result" / args.net_name / "reconstructions_train_model6"
