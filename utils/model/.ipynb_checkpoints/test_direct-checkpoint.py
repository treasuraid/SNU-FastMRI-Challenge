...
class CustomMutiDomainNet(nn.Module): 
    ...
    def __init__(self):
        ...
        self.multidomainnet = MultiDomainNet(forward_operator= T.fft2, backward_operator= T.ifft2, num_filters=8) 
    ...
    def forward(self, masked_kspace, mask) : 
        ...
        sensitivity_map = checkpoint.checkpoint(self.custom(self.sens_net), masked_kspace, mask) 
        x = checkpoint.checkpoint(self.custom(self.multidomainnet), masked_kspace, sensitivity_map)
